CREATE OR REPLACE TABLE PROCEDURE `also-analytics-model-prod.3_MATERIALIZADO_S4.DIM_CONTRATO` () 

BEGIN
		DELETE FROM `also-analytics-model-prod.1_AQUISICAO_S4.DIM_CONTRATO` WHERE 1=1;
