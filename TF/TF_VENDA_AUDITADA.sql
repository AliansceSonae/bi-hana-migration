CREATE OR REPLACE TABLE FUNCTION `also-analytics-model-nonprod.2_NEGOCIO_S4.TF_VENDA_AUDITADA_4B` () 
AS
    SELECT
        ...
        GREATEST(ZTRE016.GROSS_SALES_AUD_FIS, ZTRE016.GROSS_SALES_REDU_Z)				AS VOLVED_AUD
